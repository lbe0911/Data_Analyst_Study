...
- 처음 비즈니스 문제를 정의하는 단계부터 데이터 준비, 모델링 및 평가, 그리고 스토리텔링까지, 데이터 분석가라면 반드시 알아야 하는 모든 내용을 다룬다. 또한 불필요한 수식과 이론을 최대한 배제하고, 비전공자라도 개념을 쉽게 이해할 수 있도록 구성되어 보였고, 더불어 이 책의 대상 독자로 아래 3가지를 제시하였는데
